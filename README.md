...
> [!NOTE]
> DMS-O2 forces HTTPS by default. The setup scripts automatically generate TLS certificates for your LAN IP using [mkcert](https://github.com/FiloSottile/mkcert) or OpenSSL. All plain HTTP requests are automatically redirected to HTTPS.
