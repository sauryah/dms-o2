...
urlpatterns = [
    ...
    path('api/v1/auth/backup-codes/generate/', BackupCodeGenerateView.as_view(), name='backup-codes-generate'),
    path('api/v1/auth/backup-codes/verify/', BackupCodeVerifyLoginView.as_view(), name='backup-codes-verify'),
    path('api/v1/auth/backup-codes/disable/', BackupCodeDisableView.as_view(), name='backup-codes-disable'),
    path('api/v1/auth/backup-codes/status/', BackupCodeStatusView.as_view(), name='backup-codes-status'),
    ...
    path('api/auth/backup-codes/generate/', BackupCodeGenerateView.as_view()),
    path('api/auth/backup-codes/verify/', BackupCodeVerifyLoginView.as_view()),
    path('api/auth/backup-codes/disable/', BackupCodeDisableView.as_view()),
    path('api/auth/backup-codes/status/', BackupCodeStatusView.as_view()),
