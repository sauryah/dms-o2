...
describe('normalizeDieSize', () => {
  it('normalizes decimal variants to the same hundred-thousandths key', () => {
    ...
    expect(normalizeDieSize('620').hundredThousands).toBe(62000)
    expect(normalizeDieSize('500').hundredThousands).toBe(50000)
    expect(normalizeDieSize('365').hundredThousands).toBe(36500)
    expect(normalizeDieSize('050').hundredThousands).toBe(5000)
