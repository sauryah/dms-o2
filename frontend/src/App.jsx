import React, { createContext, useContext, useState, useEffect, useMemo, useRef, useCallback, memo } from 'react'
import { 
...
function InventoryPage() {
  ...
  const toggleMachine = useCallback((id) => {
  ...
  const handleDropOnMachine = useCallback((e, machineId) => {
    e.preventDefault()
  ...
  const handleDropOnSet = useCallback((e, setId) => {
    e.preventDefault()
    setDragOverNode(null)
    setActiveDragType(null)
    if (role !== 'ROOT' && role !== 'ADMIN') return
  ...
  const handleDropOnUnassigned = useCallback((e) => {
    e.preventDefault()
    setDragOverNode(null)
    setActiveDragType(null)
    if (role !== 'ROOT' && role !== 'ADMIN') return
  ...
  const handleDragStartDie = useCallback((id) => {
